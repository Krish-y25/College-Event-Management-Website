...
// REMOVED: Import of sampleRooms, sampleBookings, sampleStudySpots
...
export const getRooms = async (): Promise<Room[]> => {
  try {
    ...
    return rooms; // Returns empty array if no rooms exist
  } catch (error) {
...
export const getStudySpots = async (): Promise<StudySpot[]> => {
  try {
    ...
    return spots; // Returns empty array if no spots exist
  } catch (error) {
...
export const getBookings = async (): Promise<Booking[]> => {
  try {
    ...
    return bookings; // Returns empty array if no bookings exist
  } catch (error) {
